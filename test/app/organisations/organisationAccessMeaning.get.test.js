...
describe('when displaying the help page for organisations/organisationAccessMeaning', () => {
  ...
  beforeEach(() => {
    req = getRequestMock();
    res.mockResetAll();
    getDashboard = require('../../../src/app/organisations/organisationAccessMeaning').get;
  });
  ...
  it('should render the help page for organisations/organisationAccessMeaning', async () => {
    ...
    expect(res.render.mock.calls[0][0]).toBe('organisations/views/organisationAccessMeaning');
  });
