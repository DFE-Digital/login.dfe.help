...
const { get } = require("../../../src/app/manageConsole/aboutManageConsole");
const {
...
describe("when displaying the help page for manageConsole/aboutManageConsole", () => {
  let req;
  ...
  beforeEach(() => {
    req = mockRequest({
      ...
      userServices: {
        ...
        userId: "user1",
        roles: [
          { code: "service1_servicesup" },
          { code: "service1_serviceSup" },
          { code: "service1_accessManage" },
          { code: "service1_onboardSvc" },
        ],
      },
    });
    ...
    getSingleUserServiceAndRoles
      .mockReset()
      .mockReturnValue(["serviceconfig", "serviceSup", "accessManage"]);
  });

  it("should render the help page for manageConsole/aboutManageConsole", async () => {
    await get(req, res);

    expect(res.render.mock.calls).toHaveLength(1);
    expect(res.render.mock.calls[0][0]).toBe(
      "manageConsole/views/aboutManageConsole",
    );
  });
