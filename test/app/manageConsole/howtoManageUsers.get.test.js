...
const { get } = require("../../../src/app/manageConsole/howtoManageUsers");
const {
...
describe("when displaying the help page for manageConsole/gethowtoManageUsers", () => {
  let req;
  ...
  it("should render the help page for manageConsole/howToManageUsers", async () => {
    await get(req, res);

    expect(res.render.mock.calls).toHaveLength(1);
    expect(res.render.mock.calls[0][0]).toBe(
      "manageConsole/views/howtoManageUsers",
    );
  });
