...
const { get: getCanEndUserRequestService } = require('./canEndUserRequestService');
...
const routes = (csrf) => {
  ...
  router.get('/can-end-user-request-service', csrf, asyncWrapper(getCanEndUserRequestService));
